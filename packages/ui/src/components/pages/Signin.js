...
const Signin = () => {
    ...
    const notify_fail = () =>
        toast.error('Sign in faild, maybe... network issue.', {
            position: 'top-right',
            autoClose: 2000,
    ...
    const notify_warning = (index) =>
        toast.warning(index == 1 ? 'Email or Password wrong!' : "Email or Password can't be empty", {
            position: 'top-right',
            autoClose: 2000,
            hideProgressBar: false,
            closeOnClick: true,
                ...
                <Tab eventKey='main' title='With Email'>
                    <div className='account-form asix-mt-40'>
                        ...
                        <div className='form-group asix-mt-40'>
                            <button className='asix-pink-fill-btn' onClick={() => sign_in(1)}>
                                Sign In{' '}
                            </button>
                        </div>
                    </div>
                    ...
                    <div className='account-form asix-mt-40'>
                        {walletConnected ? (
                            <>
                                ...
                                <div className='form-group asix-mt-40'>
                                    <button className='asix-pink-fill-btn' onClick={() => sign_in(2)}>
                                        Sign In{' '}
                                    </button>
                                </div>
                            </>
